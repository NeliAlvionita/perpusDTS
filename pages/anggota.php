...
<div id="content">
	...
	<a target="_blank" href="pages/anggota-cetak.php"><img src="images/print.png" height="50px" height="50px"></a>
	<a target="_blank" href="pages/ekspor/anggota-ekspor-pdf.php"><img src="images/pdf.jpg" height="50px" height="50px"></a>
	<a target="_blank" href="pages/ekspor/anggota-ekspor-excel.php"><img src="images/excel.jpg" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a target="_blank" href="pages/anggota-cetak-kartu.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" class="tombol">Cetak Kartu</a></div>
