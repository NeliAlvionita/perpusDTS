...
<div id="content">
	...
	<a target="_blank" href="pages/buku-cetak.php"><img src="images/print.png" height="50px" height="50px"></a>
	<a target="_blank" href="pages/ekspor/buku-ekspor-pdf.php"><img src="images/pdf.jpg" height="50px" height="50px"></a>
	<a target="_blank" href="pages/ekspor/buku-ekspor-excel.php"><img src="images/excel.jpg" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		if($_SERVER['REQUEST_METHOD'] == "POST"){
			...
			if($pencarian != ""){
				$sql = "SELECT * FROM tbbuku WHERE judul LIKE '%$pencarian%'
                        ...
                        OR tahun terbit LIKE '%$pencarian%'";
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a target="_blank" href="pages/buku-cetak-kartu.php?id=<?php echo $r_tampil_buku['idbuku'];?>" class="tombol">Cetak Kartu</a></div>
